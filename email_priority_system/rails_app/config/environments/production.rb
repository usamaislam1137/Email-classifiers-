...
Rails.application.configure do
  ...
  # Mount Action Cable outside main process or target.
  # config.action_cable.mount_path = nil
  # config.action_cable.url = "wss://example.com/cable"
  # config.action_cable.allowed_request_origins = [ "http://example.com", /http:\/\/example\.com.*/ ]
  ...
  # Log to STDOUT by default for better integration with modern cloud platforms.
  ...
  # Set this to true and configure the email server for immediate error notification of delivery failures.
